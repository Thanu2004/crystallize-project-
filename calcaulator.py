...
def cal():
    ...
    cal_button_bg = '#FFF8DC'
    num_button_bg = '#FF1493'
    other_button_bg = '#ADD8E6'
    text_fg = '#000000'
    button_active_bg = '#BC8F8F'
    ...
    exit = Button(root, text='Quit', fg='white', bg='Tan', command=quit, height=1, width=7)
